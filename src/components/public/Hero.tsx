...
export default function Hero({ textes }: HeroProps) {
  return (
    <section id="hero" className="grid grid-cols-1 md:grid-cols-2 min-h-screen pt-16"
      ...
      <div className="hidden md:flex items-center justify-center gap-4 px-8 py-20">
        <div className="w-44 h-64 rounded-sm border border-or/25 flex flex-col items-center justify-center gap-3"
        ...
        <div className="flex flex-col gap-4">
          <div className="w-32 h-36 rounded-sm border border-or/15 flex flex-col items-center justify-center gap-2"
          ...
          <div className="w-32 h-24 rounded-sm border border-or/10 flex flex-col items-center justify-center gap-2"
