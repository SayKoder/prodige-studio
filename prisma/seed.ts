...
async function main() {
  ...
  const forfaits = [
    {
      categorie: 'portraits_evenements',
      nom: 'Pack Flash',
      sousTitre: 'Portrait Solo · Animal',
      prix: '79€',
      details: ['30 à 45 min de prise de vue', '3 photos retouchées avec soin', 'Livraison sous 7 jours'],
      ordre: 1,
    },
    {
      categorie: 'portraits_evenements',
      nom: 'Portrait Pro',
      sousTitre: 'Profil LinkedIn · Pro',
      prix: '149€',
      details: ['1h sur le lieu de votre choix', '7 photos retouchées avec soin', 'Idéal profil pro, LinkedIn, CV'],
      ordre: 2,
    },
    {
      categorie: 'portraits_evenements',
      nom: 'Duo & Famille',
      sousTitre: 'Séance Famille',
      prix: '179€',
      details: ['1h de prise de vue', '10 photos retouchées', 'Sélection personnalisée'],
      ordre: 3,
    },
    {
      categorie: 'portraits_evenements',
      nom: 'Forfait Événementiel',
      sousTitre: 'Salon · Soirée · Fête',
      prix: '350€',
      details: ['3h consécutives sur place', 'Reportage photo complet', '40 photos sélectionnées & retouchées'],
      ordre: 4,
    },
    {
      categorie: 'grands_forfaits',
      nom: 'Pack Premium',
      sousTitre: '12 photos + 3 offertes',
      prix: '290€',
      details: ['12 photos retouchées', '2 thèmes possibles', 'Retouches avancées'],
      populaire: false,
      ordre: 1,
    },
    {
